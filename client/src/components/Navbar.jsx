    ...
    <div>
      <nav className="flex justify-around items-center h-20 mx-auto">
        ...
        <div className="flex flex-row items-center font-medium text-slate-100 mr-5 space-x-6">
          ...
          >
            <p className="text-slate-800 hover:text-slate-950 cursor-pointer font-bold">Machines</p>
          </div>
          <div
            onClick={() =>
              navigate({
          ...
          >
            <p className="text-slate-800 hover:text-slate-950 cursor-pointer font-bold">Accessories</p>
          </div>
          <div
            onClick={() =>
              navigate({
                pathname: '/listItems',
                search: '?category=Shop All'
              })
            }
          >
            <p className="text-slate-800 hover:text-slate-950 cursor-pointer font-bold">Shop All</p>
          </div>
          <div>
            <p className="text-slate-800 hover:text-slate-950 cursor-pointer font-bold">Sale</p>
          </div>
        </div>
